    ...
    internal class FuncionarioDAO
    {
        ...
        public void Insert(Funcionario funcionario)
        {
            try
            {
                ...
                comando.Parameters.AddWithValue("@sexo", funcionario.SexoFuncionario);
        ...
        public Funcionario GetById(int id)
        {
            try
            {
                ...
                comando.CommandText = "SELECT * FROM Funcionario WHERE id_fun = @id";
                ...
                while (reader.Read())
                {
                    ...
                    funcionario.SexoFuncionario = DAOHelper.GetString(reader, "sexo_fun");
        ...
        public void Update(Funcionario funcionario)
        {
            try
            {
                ...
                comando.CommandText = "UPDATE Funcionario SET nome_fun = @nome_funcionario, email_fun = @email, cpf_fun = @cpf, rg_fun = @rg, " +
                    "endereco_fun = @endereco, telefone_fun = @telefone, turno_fun = @turno, sexo_fun = @sexo, data_nasc_fun = @data_nascimento" +
                    "WHERE id_fun = @id;";
